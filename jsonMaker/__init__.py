...
class JsonPackets():
    ...
    @staticmethod
    def standartTransaction(cryptor:VncCrypto, reciever:str, token_count:int, token_type:str): # Стандартная транзакция перевода средств
    ...
    @staticmethod
    def voteTransaction(cryptor:VncCrypto, reciever:str, vote_count:int): # Транзакция заявка на участие в следующем туре валидации
    ...
    @staticmethod
    def applicantTransaction(cryptor:VncCrypto, ip:str): # Транзакция заявка на участие в следующем туре валидации
    ...
    @staticmethod
    def createPrecommitBlock(cryptor:VncCrypto, ver:str, transactions:set, bheight:int, fee:float):
        jtransactions = []
